...
#         
        ...
        updates_G = lasagne.updates.adam(loss_Gz, params_G, learning_rate=lrg, beta1=0.5)
    #    updates_D = lasagne.updates.adam(loss_D, params_D, learning_rate=0.0002, beta1=0.5)
        updates_D_real = lasagne.updates.adam(loss_Dx, params_D, learning_rate=lrd, beta1=0.5)
        updates_D_fake = lasagne.updates.adam(loss_DGz, params_D, learning_rate=lrd, beta1=0.5)
